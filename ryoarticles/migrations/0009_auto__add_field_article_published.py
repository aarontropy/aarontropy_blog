...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ryoarticles_article', 'published',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ryoarticles_article', 'published')
    ...
    models = {
        ...
        'ryoarticles.article': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'PUB'", 'max_length': '10'}),
